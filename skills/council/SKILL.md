...
```bash
pip install 'the-llm-council>=0.7.8'
```

Optional extras:

```bash
pip install 'the-llm-council[anthropic,openai,gemini]>=0.7.8'
pip install 'the-llm-council[vertex]>=0.7.8'
```
